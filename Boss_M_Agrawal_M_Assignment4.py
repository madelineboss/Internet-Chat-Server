...
#------To-do List----------------------------------------------------------------------------------------------------------#
"""
who # currently lists all registered users; we need to list only the online users fixed?
...
other:
    - change user's online and offline status when they exit
    ...
    - fix the bugs for when user does not put in the right amount of inputs for a command
