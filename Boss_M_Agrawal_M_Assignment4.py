...
def start(sock, cmd, userName):
    ...
    for userSock in onlineUsers.values():
        mySendAll(userSock, f"!!system!!: {instance.leader} created room {instance.roomNum}, topic: {instance.topic}\n".encode())
    ...
    if room is None:
        ...
        if userName not in room.members:
            ...
            if room.leader == userName:
                ...
                for userSock in onlineUsers.values():
                    mySendAll(userSock, f"!!system!!: Room {roomNum} (topic: {room.topic}) closed\n".encode())
            else:
